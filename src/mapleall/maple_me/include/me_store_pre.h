...
class MeStorePre : public MeSSUPre {
 public:
  ...
  const MapleMap<OStIdx, MapleSet<BBId> *> &CandsForSSAUpdate() const {
 ...
 private:
  ...
  MapleMap<OSIdx, MapleSet<BBId> *> candsForSSAUpdate;
};
