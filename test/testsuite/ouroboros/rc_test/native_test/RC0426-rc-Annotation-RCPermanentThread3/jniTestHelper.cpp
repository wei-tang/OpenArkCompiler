...
JNIEXPORT jboolean JNICALL Java_RCPermanentThread3_isHeapObject__Ljava_lang_Object_2
(JNIEnv *env, jclass cls, jobject obj) {
  return MRT_CheckHeapObj((void*)obj);
}

JNIEXPORT jint JNICALL Java_RCPermanentThread3_refCount__Ljava_lang_Object_2
(JNIEnv *env, jclass cls, jobject obj) {
