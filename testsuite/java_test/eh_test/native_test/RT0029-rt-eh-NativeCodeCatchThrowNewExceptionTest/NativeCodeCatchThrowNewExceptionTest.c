...
void native_nativeNativeCodeCatchThrowNewExceptionTest (JNIEnv *env, jobject obj){
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    assert(env != NULL);
        ...
        {
                {"nativeNativeCodeCatchThrowNewExceptionTest", "()V", (void*)&native_nativeNativeCodeCatchThrowNewExceptionTest },
        };
