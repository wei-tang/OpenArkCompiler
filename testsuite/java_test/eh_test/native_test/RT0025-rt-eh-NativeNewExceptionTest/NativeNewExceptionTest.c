...
void native_nativeNativeNewExceptionTest (JNIEnv *env, jobject obj){
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    assert(env != NULL);
        ...
        {
                {"nativeNativeNewExceptionTest", "()V", (void*)&native_nativeNativeNewExceptionTest },
        };

        // if package is test:"test/NativeNewExceptionTest"
        jclass cls = (*env)->FindClass(env, "NativeNewExceptionTest");
