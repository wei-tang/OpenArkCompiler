...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass c = env->FindClass("NativeNewExceptionTest");
    if (!c) return JNI_ERR;

    // Register your class' native methods.
    static const JNINativeMethod methods[] = {
        {"nativeNativeNewExceptionTest", "()V", reinterpret_cast<void*>(Java_NativeNewExceptionTest_nativeNativeNewExceptionTest__)},
