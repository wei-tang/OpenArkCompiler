...
void native_NativeExcpAsync06150 (JNIEnv *env, jobject obj){
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    assert(env != NULL);
        ...
        {
                {"NativeExcpAsync06150", "()V", (void*)&native_NativeExcpAsync06150 },
        };

        jclass cls = (*env)->FindClass(env, "ExcpAsync06150");  //if package is test:"test/ExcpAsync06110"
