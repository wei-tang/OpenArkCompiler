...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass c = env->FindClass("NativeCheckFatalErrorExceptionTest");
    if (!c) return JNI_ERR;

    // Register your class' native methods.
    static const JNINativeMethod methods[] = {
        {"nativeNativeCheckFatalErrorExceptionTest", "()V", reinterpret_cast<void*>(Java_NativeCheckFatalErrorExceptionTest_nativeNativeCheckFatalErrorExceptionTest__)},
