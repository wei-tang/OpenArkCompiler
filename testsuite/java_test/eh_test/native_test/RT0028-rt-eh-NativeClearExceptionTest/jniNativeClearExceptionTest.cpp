...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    jclass c = env->FindClass("NativeClearExceptionTest");
    if (!c) return JNI_ERR;

    // Register your class' native methods.
    static const JNINativeMethod methods[] = {
        {"nativeNativeClearExceptionTest", "()V", reinterpret_cast<void*>(Java_NativeClearExceptionTest_nativeNativeClearExceptionTest__)},
